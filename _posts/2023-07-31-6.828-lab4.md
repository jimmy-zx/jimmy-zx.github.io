---
title: "6.828 Lab 4 Challenge: Fine-grained Locking"
date: 2023-07-31
---
...
[Link to lab4](https://pdos.csail.mit.edu/6.828/2018/labs/lab4/),
[My code](https://github.com/jimmy-zx/6.828-lab/tree/lab4),
[Original](https://github.com/jimmy-zx/6.828-lab/blob/lab4/answers-lab4.md)
...
[^1]: The check is done by `assert(lock.locked)`. Better using `kern/spinlock.c:holding()`.
